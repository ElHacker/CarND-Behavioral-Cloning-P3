...
def generator(samples, batch_size=32):
    """
    Return a shuffled set of samples read from the data file.
    :samples: the full set of samples to go through.
    :batch_size: how big is the returned sub-set of samples array going to be.
    """
